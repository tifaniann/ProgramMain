...
public class Grades()
{
    ...
    */
    ...
    Console.Clear();
    Console.WriteLine("Student\t\tExam Score\t\tOveral Score\tGrade\tExtra Credit\n");
    ...
    */
    foreach (string name in studentNames)
    {
        ...
        currentStudentGrade = (decimal)(sumAssignmentScores) / examAssignments;
        extraSum = extraCredit / CountExtra;
        decimal finalsum = (decimal)(sumExam) / examAssignments;
